...
void lookingResident(User **head, char email[], char role[], char namePreceptor[], Evaluations *Epointer)
{
  ...
  char taglist[48][200] = {"0: O residente cumpre seus ações consistentemente e com excelência", "1 :O residente poderia se empenhar mais nas tarefas de seu dia-a-dia", "2: O residente desempenha bem suas tarefas", "3: O residente deixa a desejar no compromisso com a instituição",
                           ...
                           "24: O residente lida tranquilamente com críticas e possui também um bom senso crítico", "25: O residente possui a habilidade de criticar mas não lida bem com críticas", "26: O residente aceita críticas de forma construtiva.", "27: O residente lida mal com críticas de forma geral.",
                           ...
                           "36: O residente demonstra segurança e habilidade nas suas atividades", "37: O residente tem bom domínio das práticas.", "38: O residente é confiante e seguro.", "39: O residente demonstra problemas graves no entendimento e segurança com os procedimentos.",
                           "40: O residente realiza boas e curtas observações", "41: o residente realiza boas observações.", "42: O residente realiza observações concisas.", "43: O residente escreve observações longas e confusas",
